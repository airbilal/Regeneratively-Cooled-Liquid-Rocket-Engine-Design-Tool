...
materials.wall.grade='Cu';%%SS 316-L
materials.wall.servtemp=800;%1100 K for 316L%service temp, K, i.e. around 525C
materials.wall.strength=55E6;%120E6 for 316L%yield strength, Pascals, at 525C
materials.wall.fos=4.5;%factor of safety
materials.wall.cond=400;%20 for 316L%Thermal Conductivity, W/m2/K
...
fuel(1).rho=719.7;% density, kg/m3
...
%For uncooled engine 1
[axialvariations.Taw,axialvariations.Twg.unc1,axialvariations.Two.unc1,...
    axialvariations.q.unc1,axialvariations.hg.unc1]=...
    heat_transfer_unc1(materials,...
    geom,engine,comb_chamb_st,axialvariations);
%For uncooled engine 2
[axialvariations.Tinsg.unc2,axialvariations.Twi.unc2,....
    axialvariations.Two.unc2,...
    axialvariations.q.unc2,axialvariations.hg.unc2]=...
    heat_transfer_unc2(materials,...
    geom,engine,comb_chamb_st,axialvariations);
%
%Plot results
